  ...
  return (
    <div className="list">
      ...
      <div className="listContainer">
        <Navbar />
        <div>
          <Link to={`/${cur_sys}/${cur_id}/powerReactData/method1`} style={{ textDecoration: 'none', }}>
            <button className="btnM">Method 1</button>
          </Link>
          <Link to={`/${cur_sys}/${cur_id}/powerReactData/method2`} style={{ textDecoration: 'none', }}>
            <button className="btnM">Method 2</button>
          </Link>
          <Link to={`/${cur_sys}/${cur_id}/powerReactData/method3`} style={{ textDecoration: 'none', }}>
            <button className="btnM">Method 3</button>
          </Link>
          <Link to={`/${cur_sys}/${cur_id}/powerReactData/method4`} style={{ textDecoration: 'none', }}>
            <button className="btnM">Method 4</button>
          </Link>
          <Link to={`/${cur_sys}/${cur_id}/powerReactData/method5`} style={{ textDecoration: 'none', }}>
            <button className="btnM">Method 5</button>
          </Link>
        </div>
        <Datatable title={`IEEE ${cur_sys} Bus System - Bus ${cur_id} - `+pReactData} userColumns={powerReactColumns} userRows={rows} />
        <br /><br />
